<x-app-layout>
    <div>
        ...
        <div class="mt-3">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{route('updatePermintaan',[$id,$permintaan->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('kebutuhan') is-invalid @enderror" id="kebutuhan"
                                       name="kebutuhan" value="{{ $permintaan->kebutuhan }}">
                                @error('kebutuhan')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah"
                                       name="jumlah" value="{{ $permintaan->jumlah }}" style="width: 90%; display: inline"> satuan
                                @error('jumlah')
                                <div id="validationServer03Feedback"
